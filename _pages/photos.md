...
<!--
  Photo gallery.
  Replace the demo images (assets/img/1.jpg ... 12.jpg) with your own photos,
  or add new ones under assets/img/ and update the `path=` values below.
  Each image is clickable/zoomable thanks to `data-zoomable`.
-->
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/4.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
